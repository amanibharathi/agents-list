...
export const GET_SEARCH_META_FOR_AGENT = `/api/meta/state/list/`;
...
export const GET_LEADS_DETAILS_BY_ID = (id: string) =>
  `/web/lead/detail/${id}/`;
...
export const GET_LEAD_LISTING = (lead_enquiry: string, type?: string) =>
  `/agent/lead-communication-log/list/?is_replied=false${
    lead_enquiry ? `&lead=${lead_enquiry}` : ""
  }${type ? `&communication_type=${type}` : ""}`;
...
export const LEAD_PROFILE_TAB_LIST_META = (tab: string, user_id: number) => {
  if (tab === "favorite")
    ...
    return `/web/lead/offer/list/table-meta/`;
...
export const UPDATE_STAGE_ONBOARDING = (id: any) =>
  `/agent/stage/update/${id}/`;
export const GET_AGENT_STAGE_LICENSE_LIST_ONBOARD = () =>
  `/agent/license/list/`;
...
export const AGENT_WEBSITE_DETAIL_WEB = (slug: any) =>
  `/agent/website/${slug}/`;
...
export const POST_CMS_PROFILE_PICTURE =
  "/agent/website/profile-picture/upload/";
...
export const GET_AGENTS_LIST_IN_ADMIN = (is_applied = false) =>
  `/api/agent/list/${is_applied ? "?is_applied=true" : ""}`;
export const GET_AGENTS_LIST_META_IN_ADMIN = (is_applied = false) =>
  `/api/agent/list/table-meta/${is_applied ? "?is_applied=true" : ""}`;
...
export const ADMIN_AGENT_STAGE_GET = (id: any) =>
  `/api/agent/onboarding/stage/list/?user=${id}`;
...
export const GET_LICENSE_TRANSFER_META = (access_type?: string) =>
  `/admin/transfer-license/list/table-meta/${
...
export const ADMIN_GET_TEMPLATE_LIST = (acknowledge?: any) =>
  `/admin/esign/template/list/${
    acknowledge ? `?ica_acknowledgement=${acknowledge}` : ""
  }`;
...
export const ADMIN_GET_STATE = `/api/meta/state/list/`;
export const ADMIN_GET_META_STATE = `/api/meta/state/list/`;
...
export const ADMIN_GET_TEAM_REQUEST_TABLE_LIST = (
  ...
  `/team/request/list/${status ? `?status=${status}` : ""}${
