...
import { formatToUSPhone, truncateString } from '../../../../utils/functions/commonFunctions'
import { ADMIN_MAKE_AGENT_INDIVIDUAL_PAGE } from '../navigation'
        ...
        <div className="flex justify-between">
          ...
          {notModal ? (
            <Box
              ...
              onClick={() => {
                navigate(ADMIN_MAKE_AGENT_INDIVIDUAL_PAGE(data?.id))
              }}
            >
              <ColorTags
