...
export const MAKE_SCHEDULE_TOUR_PAGE = (
  ...
  `/detail/${id}/schedule-tour/?${'type=' + type}${date ? '&date=' + date : ''}${time ? '&time=' + time : ''}${leadType ? '&lead_type=' + leadType : ''}`
...
export const MAKE_APPLIED_AGENTS_LIST_PAGE = (
  ...
  `/admin/agents/applied-agents-list?${stage_status ? '&stage_status=' + stage_status : ''}${agent_status ? '&agent_status=' + agent_status : ''}${stage ? '&stage=' + stage : ''}${onboard_type ? '&onboard_type=' + onboard_type : ''}${primary_state ? '&primary_state=' + primary_state : ''}${sort_by ? '&sort_by=' + sort_by : ''}${brokerage ? '&brokerage=' + brokerage : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}${last_active ? '&last_active=' + last_active : ''}`
export const MAKE_ACTIVE_AGENTS_LIST_PAGE = (
  ...
  `/admin/agents/agents-list/?${agent_status ? '&agent_status=' + agent_status : ''}${onboard_type ? '&onboard_type=' + onboard_type : ''}${primary_state ? '&primary_state=' + primary_state : ''}${sort_by ? '&sort_by=' + sort_by : ''}${brokerage ? '&brokerage=' + brokerage : ''}${joining_date_after ? '&joining_date_after=' + joining_date_after : ''}${joining_date_before ? '&joining_date_before=' + joining_date_before : ''}`
export const MAKE_ACTIVE_TEAMS_LIST_PAGE = (
  ...
  `/admin/agents/teams-list/?${agent_type ? '&agent_type=' + agent_type : ''}${state ? '&state=' + state : ''}${mls ? '&mls=' + mls : ''}${status ? '&status=' + status : ''}${sort_by ? '&sort_by=' + sort_by : ''}`
export const MAKE_APPLIED_TEAMS_LIST_PAGE = (
  ...
  `/admin/agents/applied-teams-list/?${agent_type ? '&agent_type=' + agent_type : ''}${state ? '&state=' + state : ''}${mls ? '&mls=' + mls : ''}${status ? '&status=' + status : ''}${sort_by ? '&sort_by=' + sort_by : ''}`
...
export const MAKE_TEAM_ROSTER_LIST_PAGE = (
  ...
  `/admin/agents/onboarding-teams/${id}/team-members?${role ? '&role=' + role : ''}${agent_status ? '&agent_status=' + agent_status : ''}${cap ? '&cap=' + cap : ''}${split ? '&split=' + split : ''}`
...
export const ADMIN_TOOLS_LISTING_PAGE = (
  ...
  `/admin/meta/tools/?${tool_type ? '&tool_type=' + tool_type : ''}${sort_by ? '&sort_by=' + sort_by : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}`
export const ADMIN_MANAGING_BROKER_LICENSE_TRANSFER_PAGE = (
  ...
  `/admin/dashboard/${tab}/${subtab}/?${status ? '&status=' + status : ''}${state ? '&state=' + state : ''}${sort_by ? '&sort_by=' + sort_by : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}`
...
export const ADMIN_FAQ_TOPIC_LISTING_PAGE = (
  ...
  `/admin/meta/faq-topic/?${sort_by ? '&sort_by=' + sort_by : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}`
...
export const ADMIN_DASHBOARD_TEAM_REQUESTS_TABS_LISTING = (
  ...
  `/admin/dashboard/team-requests/${tab}?${sort ? `&sort_by=${sort}` : ''}${status ? `&status=${status}` : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}${request_type ? `&request_type=${request_type}` : ''}${team ? `&team=${team}` : ''}`
...
export const ADMIN_TEAM_DOCUMENT_LISTING = (
  ...
  `/admin/agents/${path}/${id}/documents?${document_type ? `&document_type=${document_type}` : ''}${uploaded_by ? `&uploaded_by=${uploaded_by}` : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}${sort_by ? `&sort_by=${sort_by}` : ''}`
export const ADMIN_TEAM_REQUEST_LISTING = (
  ...
  `/admin/agents/onboarding-teams/${id}/team-requests?${request_type ? `&request_type=${request_type}` : ''}${status ? `&status=${status}` : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}${sort_by ? `&sort_by=${sort_by}` : ''}`
...
export const MAKE_ADMIN_SETTINGS_ROLES_AND_RESPONSILIBILTIES_LISTING = (
  ...
  `/admin/settings/roles-and-permissions/${tab}?${role ? `&role=${role}` : ''}${sort ? `&sort=${sort}` : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}`
export const MAKE_ADMIN_SETTINGS_USER_AND_ROLES_LISTING = (
  ...
  `/admin/settings/user-and-roles?${role ? `&role=${role}` : ''}${sort ? `&sort=${sort}` : ''}${modified_after ? '&modified_after=' + modified_after : ''}${modified_before ? '&modified_before=' + modified_before : ''}`
...
export const makeNetworkDetailPage = (isAdmin = false, id) =>
  isAdmin ? `/admin/revshare/network/${id}` : `/agent/my-revshare/network/${id}`
