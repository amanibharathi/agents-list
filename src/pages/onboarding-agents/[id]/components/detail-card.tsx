        ...
        {agentStatus ? (
          ...
          <>
            {truncateText ? (
              ...
              <AppText
                text={value || 'N/A'}
                className={`${isStateDetail ? '!text-sm !text-[#333333]' : '!text-[#000000] !text-[16px] !leading-[21px] !font-[400] whitespace-nowrap'} ${valueClassName}`}
              />
            )}
          </>
        )}
  ...
  const getAgentDetailCard = (
    ...
    return (
      <div className="flex items-center gap-[8px] ">
        ...
        <AppText
          text={value || 'N/A'}
          className={`${isStateDetail ? '!text-sm !text-[#333333]' : '!text-[#010101] !text-[15px] !leading-[21px] !font-[600]'}`}
        />
      </div>
    )
  }
                  ...
                  <div className="flex flex-col gap-[15px]">
                    ...
                    <div className="flex gap-[22px]">
                      <AppText className="text-base text-[#6D6D6D]">
                        {`License:  ${data?.agent_detail?.primary_license_no ? data?.agent_detail?.primary_license_no : 'N/A'}`}
                      </AppText>
                      <AppText className="text-base text-[#6D6D6D]" type="li">
                        {`Expires: ${data?.agent_detail?.primary_license_expiry_date ? data?.agent_detail?.primary_license_expiry_date : 'N/A'}`}
                      </AppText>
                    </div>
                  </div>
                </div>
